...
export default function Contact({ isDark = false }) {
  ...
  return (
    <div className={`contact ${isDark ? "contact--dark" : ""}`}>
      ...
      <div
        className={`contact__line ${isDark ? "contact__line--dark" : ""}`}
      ></div>

      <div className="contact__info">
        <div className="contact__info-item">
          <p
            className={`contact__info-item-icon ${
              isDark ? "contact__info-item-icon--dark" : ""
            }`}
          >
            <span
              className={`contact__info-item-icon-span ${
                isDark ? "contact__info-item-icon-span--dark" : ""
              }`}
            >
              <FiMail />
            </span>
          ...
          <a
            ...
            className={`contact__info-item-txt ${
              isDark ? "contact__info-item-txt--dark" : ""
            }`}
          >
